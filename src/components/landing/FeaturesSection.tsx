...
export function FeaturesSection() {
  return (
    <section className="terminal-benchmarks container">
  <div className="t-bench-header">
    <span className="t-green-badge">// BENCHMARKS</span>
    <h2>Performance First, <span className="terminal-cyan">Zero Fluff</span></h2>
