      ...
      <div className="sidebar-card">
        <div className="sidebar-card-title">
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: '6px' }}>
            <Compass size={14} style={{ color: 'var(--color-primary)' }} /> About {config?.name || 'DevToolsHunt'}
          </span>
        </div>
        <p className="sidebar-card-body">
          {config?.name || 'DevToolsHunt'} is a curated launch directory listing premier tools, software, and platforms in the developer-tools ecosystem.
        </p>
      </div>
